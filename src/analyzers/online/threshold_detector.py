...
class ThresholdDetector:
 ...
 description="Sharp crypto price change"
),
 ...
 description="Spike trading volume"
),
 ...
 description="Sharp rise network delay"
),
 ...
 lookback_seconds=60.0,
 description="Sharp change time synchronization"
),
 ...
 description="Extreme time desync"
),
 ...
 description="Bias in generator random numbers"
),
 ...
 description="Sharp rise geomagnetic activity"
),
 ...
 timestamp=timestamp,
 source=source,
 reason=f"Exceeded threshold: {value:.2f} > {rule.max_absolute_value:.2f}",
 ...
 timestamp=timestamp,
 source=source,
 reason=f"Value {direction} by {change_pct:.1f}% within {rule.lookback_seconds:.0f}s (was {old_value:.2f})",
 rule_description=rule.description,
